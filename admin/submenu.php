...
$query1="insert into newsub_menu(id,cat,name,price,quantity,date) values('$menuid','$cat','$name','$price','$quantity',curdate())";
...
<!--/main-header-->
 ...
 <!--//main-header-->
	...
	<div class="jumbotron">
	    <div class="row">
		<form action="" method="post">
		<input type="number" value="<?php echo $id;?>" name="menuid" hidden />
		<input type="text" placeholder="Enter Sub Menu Name" required="" name="name" class="form-control"/>
		<input type="number" placeholder="Enter 1 for veg and 2 for non veg" name="cat" class="form-control"/>
		<input type="number" placeholder="Enter Price" required="" name="price" class="form-control"/>
		<input type="number" placeholder="Enter Quantity" required="" name="quantity" class="form-control"/>
