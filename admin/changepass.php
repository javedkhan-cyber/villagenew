								...
								<nav class="navbar navbar-default">
									<div class="navbar-header">
										<button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
										 ...
										 <h1><a  href="dashboard.php"><span style="font-size:35px">Hotel Kanha INN</span> <p class="s-log" style="font-size:20px"></p></a>
										</h1>
									</div>
									<!-- navbar-header -->
...
<section id="content">
     <?php
         ...
         $sq="select password from tbl_admin"; 
...
if($new==$confirm)
{
     $sq="update tbl_admin set password='$new'";
    ...
    <center>
        ...
        <table>
            ...
            <tr><td> Old password</td>
                <?php while($fet=  mysqli_fetch_assoc($qn)){ ?>
                
                <td><input type="password" name="p1" value="<?php  echo $fet['password'];}?>"></td></tr>
                    <tr><td> New password</td>
                <td><input type="password" name="p2" required ></td></tr>
                    <tr><td> Confirm password</td>
                        <td><input type="password" name="p3" required ></td></tr>
                    <tr><td><input type="submit" value="submit" name="sub3"></td></tr>
